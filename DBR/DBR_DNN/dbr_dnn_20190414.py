...
# train set file name
statefilename = './trainset/state_trainset01.txt'
Rfilename = './trainset/R_trainset01.txt'
...
def main():
    with tf.Session() as sess:
        ...
        net = tf.layers.dense(net, OUTPUT_SIZE, activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.variance_scaling_initializer(), bias_initializer=tf.contrib.layers.variance_scaling_initializer())
        Rpred = net

...
class FC_DNN:
        ...
        def __init__(self, session: tf.Session, input_size: int, output_size: int, batch_size: int, num_layer: int, num_neuron: int, learning_rate: float, name: str):
                ...
                self._build_network(batch_size, num_layer,
                                    num_neuron, learning_rate)   
        ...
        def _build_network(self, batch_size, num_layer, num_neuron, learning_rate):
                ...
                net = tf.contrib.layers.fully_connected(net, self.output_size, activation_fn=None)
                self.Rpred = net
                ...
                optimizer = tf.train.AdamOptimizer(learning_rate=learning_rate, beta2=0.7, epsilon=0.1)

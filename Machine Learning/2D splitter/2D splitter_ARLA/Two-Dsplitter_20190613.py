...
def main():
    ...
    # rP2 = TwoCal.band_reward(P2, 270e-6, wavelength, bandwidth)
    # rP3 = TwoCal.band_reward(P3, 330e-6, wavelength, bandwidth)
    rP1 = TwoCal.broad_reward(P1, wavelength)
    rP2 = TwoCal.broad_reward(P2, wavelength)
    rP3 = TwoCal.broad_reward(P3, wavelength)
